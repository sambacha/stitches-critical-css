...
export const keywordValues = {
  ...
  fontSizeAdjust: ['none', 'ex-height', 'cap-height', 'ch-width', 'ic-width', 'ic-height', 'from-font'],
  fontStretch: [
    'normal',
    'ultra-condensed',
    'extra-condensed',
  ...
  gridAutoColumns: ['none', 'content', 'auto', 'min-content', 'max-content', 'fit-content'],
  gridAutoFlow: ['row', 'column', 'dense'],
  gridAutoRows: ['none', 'content', 'auto', 'min-content', 'max-content', 'fit-content'],
